...
(async () => {
    try {
        const argv: TransactionMaker.Transaction.IssueEntityFactoryTransactionParams = {
        ...
        const result = await bfmetaTrMaker.transaction.generateIssueEntityFactory(argv);
