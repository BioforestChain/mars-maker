...
@Injectable()
export class GenerateAccountFactory extends CommonFactory<TransactionMaker.Common.AccountInfo> {
    readonly EXEC_API_PATH = COMMON_API_PATH.GENERATE_ACCOUNT;

    async exec(request: TransactionMaker.Common.GenerateAccountParams) {
