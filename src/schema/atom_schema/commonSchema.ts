...
/**admin通用参数 */
export const ADMIN_COMMON_PARAM: TransactionMaker.SchemaType = {
    type: "object",
    properties: {
        verifyType: {
...
/**user通用参数 */
export const USER_COMMON_PARAM: TransactionMaker.SchemaType = {
    type: "object",
    properties: {
        userKey: {
            type: BASE_ARGS_TYPE.STRING,
...
/**交易通用参数 */
export const TR_COMMON_PARAM: TransactionMaker.SchemaType = {
    type: "object",
    properties: {
        secret: {
            type: BASE_ARGS_TYPE.STRING,
