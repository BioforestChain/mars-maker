...
@Injectable()
export class AsymmetricDecryptFactory extends CommonFactory<BFMetaPcSdk.Common.AsymmetricDecrypt> {
    readonly EXEC_API_PATH = COMMON_API_PATH.ASYMMETRIC_DECRYPT;

    async exec(request: BFMetaPcSdk.Common.AsymmetricDecryptParams) {
