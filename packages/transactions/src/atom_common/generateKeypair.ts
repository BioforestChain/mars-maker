...
@Injectable()
export class GenerateKeypairFactory extends CommonFactory<BFChainPcSdk.Common.Keypairs> {
    readonly EXEC_API_PATH = COMMON_API_PATH.GENERATE_KEYPAIR;

    async exec(request: BFChainPcSdk.Common.GenerateKeypairParams) {
        ...
        const keypairs: BFChainPcSdk.Common.Keypairs = {
            keypair: {
