...
export abstract class BasicGetApi<T extends BFChainPcSdk.Basic.BasicApiRequestResult> {
    ...
    async sendGetRequest(argv?: BFChainPcSdk.Basic.BasicApiRequestParams) {
        ...
        try {
            const result = await this.networkHelper.sendGetRequest<BFChainPcSdk.Basic.BasicApiReturn<T>>(apiPath, argv);
            return result;
        } catch (e) {
