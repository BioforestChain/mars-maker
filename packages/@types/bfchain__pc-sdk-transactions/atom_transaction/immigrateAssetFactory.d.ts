...
export declare class ImmigrateAssetFactory extends TransactionFactory<ImmigrateAssetTransaction> {
    ...
    generateTransaction(request: BFChainPcSdk.Transaction.ImmigrateAssetTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.ImmigrateAssetAssetJSON>, "recipientId"> & {
        recipientId: string;
    }>;
}
