...
export declare class GiftAssetFactory extends TransactionFactory<GiftAssetTransaction> {
    ...
    generateTransaction(request: BFMetaPcSdk.Transaction.GiftAssetTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.GiftAssetAssetJSON>, "recipientId"> & {
