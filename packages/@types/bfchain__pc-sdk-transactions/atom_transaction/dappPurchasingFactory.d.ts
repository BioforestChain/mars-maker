...
export declare class DAppPurchasingFactory extends TransactionFactory<DAppPurchasingTransaction> {
    ...
    generateTransaction(request: BFChainPcSdk.Transaction.DAppPurchasingTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.DAppPurchasingAssetJSON>, "recipientId"> & {
        recipientId: string;
    }>;
}
