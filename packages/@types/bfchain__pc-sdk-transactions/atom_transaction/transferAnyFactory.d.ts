...
export declare class TransferAnyFactory extends TransactionFactory<TransferAnyTransaction> {
    ...
    generateTransaction(request: BFChainPcSdk.Transaction.TransferAnyTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.TransferAnyAssetJSON>, "recipientId"> & {
        recipientId: string;
    }>;
}
