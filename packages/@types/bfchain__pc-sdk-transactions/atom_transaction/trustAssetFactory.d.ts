...
export declare class TrustAssetFactory extends TransactionFactory<TrustAssetTransaction> {
    ...
    generateTransaction(request: BFMetaPcSdk.Transaction.TrustAssetTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.TrustAssetAssetJSON>, "recipientId"> & {
        recipientId: string;
    }>;
}
