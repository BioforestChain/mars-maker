...
export declare class SetLnsRecordValueFactory extends TransactionFactory<SetLnsRecordValueTransaction> {
    ...
    generateTransaction(request: BFChainPcSdk.Transaction.SetLnsRecordValueTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.SetLnsRecordValueAssetJSON>, "recipientId"> & {
