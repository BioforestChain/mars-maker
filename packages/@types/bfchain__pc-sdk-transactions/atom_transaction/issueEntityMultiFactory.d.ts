...
export declare class IssueEntityMultiFactory extends TransactionFactory<IssueEntityMultiTransactionV1> {
    ...
    generateTransaction(request: BFMetaPcSdk.Transaction.IssueEntityMultiTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.IssueEntityMultiAssetV1JSON>, "recipientId"> & {
        recipientId: string;
    }>;
}
