...
export declare class DelegateFactory extends TransactionFactory<DelegateTransaction> {
    ...
    generateTransaction(request: BFMetaPcSdk.Transaction.DelegateTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.DelegateAssetJSON>, "recipientId"> & {
