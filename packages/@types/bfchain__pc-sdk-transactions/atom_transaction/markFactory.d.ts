...
export declare class MarkFactory extends TransactionFactory<MarkTransaction> {
    ...
    generateTransaction(request: BFMetaPcSdk.Transaction.MarkTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.MarkAssetJSON>, "recipientId"> & {
        recipientId: string;
    }>;
}
