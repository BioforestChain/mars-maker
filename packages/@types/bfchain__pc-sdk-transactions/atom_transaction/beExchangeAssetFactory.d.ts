...
export declare class BeExchangeAssetFactory extends TransactionFactory<BeExchangeAssetTransaction> {
    ...
    generateTransaction(request: BFChainPcSdk.Transaction.BeExchangeAssetTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.BeExchangeAssetAssetJSON>, "recipientId"> & {
        recipientId: string;
    }>;
}
