...
export declare class SetLnsManagerFactory extends TransactionFactory<SetLnsManagerTransaction> {
    ...
    generateTransaction(request: BFChainPcSdk.Transaction.SetLnsManagerTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.SetLnsManagerAssetJSON>, "recipientId"> & {
        recipientId: string;
    }>;
}
