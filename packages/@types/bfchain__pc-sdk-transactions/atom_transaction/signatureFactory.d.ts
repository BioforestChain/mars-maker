...
export declare class SignatureFactory extends TransactionFactory<SignatureTransaction> {
    ...
    generateTransaction(request: BFChainPcSdk.Transaction.SignatureTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.SignatureAssetJSON>, "recipientId"> & {
