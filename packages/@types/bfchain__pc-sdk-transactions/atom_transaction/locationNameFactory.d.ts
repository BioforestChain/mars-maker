...
export declare class LocationNameFactory extends TransactionFactory<LocationNameTransaction> {
    ...
    generateTransaction(request: BFMetaPcSdk.Transaction.LocationNameTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.LocationNameAssetJSON>, "recipientId"> & {
        recipientId: string;
    }>;
}
