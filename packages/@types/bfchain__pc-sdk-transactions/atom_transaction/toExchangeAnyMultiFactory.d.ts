...
export declare class ToExchangeAnyMultiFactory extends TransactionFactory<ToExchangeAnyMultiTransaction> {
    ...
    generateTransaction(request: BFChainPcSdk.Transaction.ToExchangeAnyMultiTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.ToExchangeAnyMultiAssetJSON>, "recipientId"> & {
