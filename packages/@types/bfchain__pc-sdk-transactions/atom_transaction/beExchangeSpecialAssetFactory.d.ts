...
export declare class BeExchangeSpecialAssetFactory extends TransactionFactory<BeExchangeSpecialAssetTransaction> {
    ...
    generateTransaction(request: BFMetaPcSdk.Transaction.BeExchangeSpecialAssetTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.BeExchangeSpecialAssetAssetJSON>, "recipientId"> & {
        recipientId: string;
    }>;
}
