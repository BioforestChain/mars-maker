...
export declare class ToExchangeSpecialAssetFactory extends TransactionFactory<ToExchangeSpecialAssetTransaction> {
    ...
    generateTransaction(request: BFChainPcSdk.Transaction.ToExchangeSpecialAssetTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.ToExchangeSpecialAssetAssetJSON>, "recipientId"> & {
