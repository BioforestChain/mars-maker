...
export declare class TransferAssetFactory extends TransactionFactory<TransferAssetTransaction> {
    ...
    generateTransaction(request: BFMetaPcSdk.Transaction.TransferAssetTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.TransferAssetAssetJSON>, "recipientId"> & {
        recipientId: string;
    }>;
}
