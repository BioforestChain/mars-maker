...
export declare class RejectVoteFactory extends TransactionFactory<RejectVoteTransaction> {
    ...
    generateTransaction(request: BFMetaPcSdk.Transaction.RejectVoteTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.RejectVoteAssetJSON>, "recipientId"> & {
