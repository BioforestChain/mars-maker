...
export declare class AcceptVoteFactory extends TransactionFactory<AcceptVoteTransaction> {
    ...
    generateTransaction(request: BFMetaPcSdk.Transaction.AcceptVoteTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.AcceptVoteAssetJSON>, "recipientId"> & {
