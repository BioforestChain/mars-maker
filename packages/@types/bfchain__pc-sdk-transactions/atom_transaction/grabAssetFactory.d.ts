...
export declare class GrabAssetFactory extends TransactionFactory<GrabAssetTransaction> {
    ...
    generateTransaction(request: BFChainPcSdk.Transaction.GrabAssetTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.GrabAssetAssetJSON>, "recipientId"> & {
        recipientId: string;
    }>;
}
