...
export declare class BeExchangeAnyFactory extends TransactionFactory<BeExchangeAnyTransaction> {
    ...
    generateTransaction(request: BFMetaPcSdk.Transaction.BeExchangeAnyTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.BeExchangeAnyAssetJSON>, "recipientId"> & {
        recipientId: string;
    }>;
}
