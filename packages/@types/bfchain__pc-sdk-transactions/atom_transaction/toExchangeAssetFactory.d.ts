...
export declare class ToExchangeAssetFactory extends TransactionFactory<ToExchangeAssetTransaction> {
    ...
    generateTransaction(request: BFMetaPcSdk.Transaction.ToExchangeAssetTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.ToExchangeAssetAssetJSON>, "recipientId"> & {
