...
export declare class EmigrateAssetFactory extends TransactionFactory<EmigrateAssetTransaction> {
    ...
    generateTransaction(request: BFMetaPcSdk.Transaction.EmigrateAssetTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.EmigrateAssetAssetJSON>, "recipientId"> & {
        recipientId: string;
    }>;
}
