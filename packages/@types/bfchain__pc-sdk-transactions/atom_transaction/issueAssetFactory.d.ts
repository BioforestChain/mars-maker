...
export declare class IssueAssetFactory extends TransactionFactory<IssueAssetTransaction> {
    ...
    generateTransaction(request: BFChainPcSdk.Transaction.IssueAssetTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.IssueAssetAssetJSON>, "recipientId"> & {
        recipientId: string;
    }>;
}
