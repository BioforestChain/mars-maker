...
export declare class BeExchangeAnyMultiFactory extends TransactionFactory<BeExchangeAnyMultiTransaction> {
    ...
    generateTransaction(request: BFChainPcSdk.Transaction.BeExchangeAnyMultiTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.BeExchangeAnyMultiAssetJSON>, "recipientId"> & {
        recipientId: string;
    }>;
}
