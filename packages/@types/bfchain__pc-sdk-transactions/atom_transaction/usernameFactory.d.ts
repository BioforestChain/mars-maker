...
export declare class UsernameFactory extends TransactionFactory<UsernameTransaction> {
    ...
    generateTransaction(request: BFChainPcSdk.Transaction.UsernameTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.UsernameAssetJSON>, "recipientId"> & {
