...
export declare class RegisterChainFactory extends TransactionFactory<RegisterChainTransaction> {
    ...
    generateTransaction(request: BFChainPcSdk.Transaction.RegisterChainTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.RegisterChainAssetJSON>, "recipientId"> & {
