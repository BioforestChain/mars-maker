...
export declare class GrabAnyFactory extends TransactionFactory<GrabAnyTransaction> {
    ...
    generateTransaction(request: BFMetaPcSdk.Transaction.GrabAnyTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.GrabAnyAssetJSON>, "recipientId"> & {
        recipientId: string;
    }>;
}
