...
export declare class GiftAnyFactory extends TransactionFactory<GiftAnyTransaction> {
    ...
    generateTransaction(request: BFMetaPcSdk.Transaction.GiftAnyTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.GiftAnyAssetJSON>, "recipientId"> & {
