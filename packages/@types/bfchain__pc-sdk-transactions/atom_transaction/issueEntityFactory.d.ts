...
export declare class IssueEntityFactory extends TransactionFactory<IssueEntityTransaction> {
    ...
    generateTransaction(request: BFMetaPcSdk.Transaction.IssueEntityTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.IssueEntityAssetV1JSON>, "recipientId"> & {
        recipientId: string;
    }>;
}
