...
export declare class IssueEntityFactory extends TransactionFactory<IssueEntityTransaction> {
    ...
    generateTransaction(request: BFChainPcSdk.Transaction.IssueEntityTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.IssueEntityAssetV1JSON>, "recipientId"> & {
        recipientId: string;
    }>;
}
