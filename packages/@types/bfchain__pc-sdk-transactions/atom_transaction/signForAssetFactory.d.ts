...
export declare class SignForAssetFactory extends TransactionFactory<SignForAssetTransaction> {
    ...
    generateTransaction(request: BFMetaPcSdk.Transaction.SignForAssetTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.SignForAssetAssetJSON>, "recipientId"> & {
        recipientId: string;
    }>;
}
