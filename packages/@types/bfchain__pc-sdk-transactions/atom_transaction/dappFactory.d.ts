...
export declare class DAppFactory extends TransactionFactory<DAppTransaction> {
    ...
    generateTransaction(request: BFMetaPcSdk.Transaction.DAppTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.DAppAssetJSON>, "recipientId"> & {
        recipientId: string;
    }>;
}
