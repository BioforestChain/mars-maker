...
export declare class IssueEntityFactoryFactory extends TransactionFactory<IssueEntityFactoryTransaction> {
    ...
    generateTransaction(request: BFChainPcSdk.Transaction.IssueEntityFactoryTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.IssueEntityFactoryAssetJSON>, "recipientId"> & {
        recipientId: string;
    }>;
}
