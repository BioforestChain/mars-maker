...
export declare class DestoryEntityFactory extends TransactionFactory<DestoryEntityTransaction> {
    ...
    generateTransaction(request: BFMetaPcSdk.Transaction.DestoryEntityTransactionParams): Promise<Omit<BFChainCore.TransactionJSON<BFChainCore.DestoryEntityAssetJSON>, "recipientId"> & {
        recipientId: string;
    }>;
}
