...
export declare class IssueAssetApi extends TransactionApi<BFChainCore.IssueAssetTransactionJSON> {
    ...
    generateTransaction(argv: BFChainPcSdk.Transaction.IssueAssetTransactionParams): Promise<
        ...
        >
    >;
    broadcastTransaction(transaction: BFChainCore.IssueAssetTransactionJSON): Promise<
