...
export declare class SetLnsRecordValueApi extends TransactionApi<BFChainCore.SetLnsRecordValueTransactionJSON> {
    ...
    generateTransaction(argv: BFChainPcSdk.Transaction.SetLnsRecordValueTransactionParams): Promise<
        ...
        >
    >;
    broadcastTransaction(transaction: BFChainCore.SetLnsRecordValueTransactionJSON): Promise<
