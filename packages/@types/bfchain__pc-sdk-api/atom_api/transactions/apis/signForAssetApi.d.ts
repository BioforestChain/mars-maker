...
export declare class SignForAssetApi extends TransactionApi<BFChainCore.SignForAssetTransactionJSON> {
    ...
    generateTransaction(argv: BFChainPcSdk.Transaction.SignForAssetTransactionParams): Promise<
        ...
        >
    >;
    broadcastTransaction(transaction: BFChainCore.SignForAssetTransactionJSON): Promise<
