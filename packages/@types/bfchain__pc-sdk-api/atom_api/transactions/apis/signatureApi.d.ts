...
export declare class SignatureApi extends TransactionApi<BFChainCore.SignatureTransactionJSON> {
    ...
    generateTransaction(argv: BFChainPcSdk.Transaction.SignatureTransactionParams): Promise<
        ...
        >
    >;
    broadcastTransaction(transaction: BFChainCore.SignatureTransactionJSON): Promise<
