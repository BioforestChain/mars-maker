...
export declare class DAppApi extends TransactionApi<BFChainCore.DAppTransactionJSON> {
    ...
    generateTransaction(argv: BFChainPcSdk.Transaction.DAppTransactionParams): Promise<
        ...
        >
    >;
    broadcastTransaction(transaction: BFChainCore.DAppTransactionJSON): Promise<
