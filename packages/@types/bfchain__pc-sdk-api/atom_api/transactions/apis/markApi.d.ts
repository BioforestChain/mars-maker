...
export declare class MarkApi extends TransactionApi<BFChainCore.MarkTransactionJSON> {
    ...
    generateTransaction(argv: BFChainPcSdk.Transaction.MarkTransactionParams): Promise<
        ...
        >
    >;
    broadcastTransaction(transaction: BFChainCore.MarkTransactionJSON): Promise<
