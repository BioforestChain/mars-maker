...
export declare class GiftAssetApi extends TransactionApi<BFChainCore.GiftAssetTransactionJSON> {
    ...
    generateTransaction(argv: BFChainPcSdk.Transaction.GiftAssetTransactionParams): Promise<
        ...
        >
    >;
    broadcastTransaction(transaction: BFChainCore.GiftAssetTransactionJSON): Promise<
