...
export declare class DAppPurchasingApi extends TransactionApi<BFChainCore.DAppPurchasingTransactionJSON> {
    ...
    generateTransaction(argv: BFChainPcSdk.Transaction.DAppPurchasingTransactionParams): Promise<
        ...
        >
    >;
    broadcastTransaction(transaction: BFChainCore.DAppPurchasingTransactionJSON): Promise<
