...
export declare class TrustAssetApi extends TransactionApi<BFChainCore.TrustAssetTransactionJSON> {
    ...
    generateTransaction(argv: BFChainPcSdk.Transaction.TrustAssetTransactionParams): Promise<
        ...
        >
    >;
    broadcastTransaction(transaction: BFChainCore.TrustAssetTransactionJSON): Promise<
