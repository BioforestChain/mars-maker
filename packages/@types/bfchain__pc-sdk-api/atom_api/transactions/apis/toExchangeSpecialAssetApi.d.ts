...
export declare class ToExchangeSpecialAssetApi extends TransactionApi<BFChainCore.ToExchangeSpecialAssetTransactionJSON> {
    ...
    generateTransaction(argv: BFChainPcSdk.Transaction.ToExchangeSpecialAssetTransactionParams): Promise<
        ...
        >
    >;
    broadcastTransaction(transaction: BFChainCore.ToExchangeSpecialAssetTransactionJSON): Promise<
