...
export declare class VoteApi extends TransactionApi<BFChainCore.VoteTransactionJSON> {
    ...
    generateTransaction(argv: BFChainPcSdk.Transaction.VoteTransactionParams): Promise<
        ...
        >
    >;
    broadcastTransaction(transaction: BFChainCore.VoteTransactionJSON): Promise<
