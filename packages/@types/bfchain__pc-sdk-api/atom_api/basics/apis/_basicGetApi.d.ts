export declare abstract class BasicGetApi<T extends BFMetaPcSdk.Basic.BasicApiRequestResult> {
    ...
    sendGetRequest(argv?: BFMetaPcSdk.Basic.BasicApiRequestParams): Promise<BFMetaPcSdk.Basic.BasicApiReturn<T>>;
}
