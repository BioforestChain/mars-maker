export declare class BasicApi {
    ...
    getTransactionType(
        argv: BFChainPcSdk.Basic.GetTransactionTypeParams
    ): Promise<BFChainPcSdk.Basic.BasicApiReturn<BFChainPcSdk.Basic.GetTransactionTypeResult>>;
    ...
    getAccountPublicKey(
        argv: BFChainPcSdk.Basic.GetAccountPublicKeyParams
    ): Promise<BFChainPcSdk.Basic.BasicApiReturn<BFChainPcSdk.Basic.GetAccountPublicKeyResult>>;
    getAccountLastTransaction(
        argv: BFChainPcSdk.Basic.GetAccountLastTransactionParams
    ): Promise<BFChainPcSdk.Basic.BasicApiReturn<BFChainPcSdk.Basic.GetAccountLastTransactionResult>>;
